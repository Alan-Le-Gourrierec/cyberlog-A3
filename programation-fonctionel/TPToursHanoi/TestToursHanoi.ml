...
(*ceci est parfaitement normale que nous ayons une erreur, car nous ne le comparons à rien contrairement a la question 
précédente (il ne peux donc pas déterminer si il est différents ou non) et donc nous n'obtenons que l'erreur*)
print_string "Test3 : "
;; 
print_string "if you see FAILURE then ok\n"
;;
make tour1 tour2 tour3bis
;; 
*)
